...
import com.dromedicas.dto.Transaccion;

/**
 * Home object for domain model class Transaccion.
 * @see com.dromedicas.dto.Transaccion
...
public class TransaccionHome {
	...
	public Transaccion merge(Transaccion detachedInstance) {
		...
		try {
			Transaccion result = (Transaccion) sessionFactory
	...
	public Transaccion findById(java.lang.Integer id) {
		...
		try {
			Transaccion instance = (Transaccion) sessionFactory
					.getCurrentSession().get("com.dromedicas.dto.Transaccion",
							id);
			if (instance == null) {
	...
	public List findByExample(Transaccion instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.dromedicas.dto.Transaccion")

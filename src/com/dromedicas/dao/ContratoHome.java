...
import com.dromedicas.dto.Contrato;
import com.dromedicas.dto.ContratoId;

/**
 * Home object for domain model class Contrato.
 * @see com.dromedicas.dto.Contrato
 * @author Hibernate Tools
 */
public class ContratoHome {

	private static final Log log = LogFactory.getLog(ContratoHome.class);
	...
	public Contrato merge(Contrato detachedInstance) {
		...
		try {
			Contrato result = (Contrato) sessionFactory.getCurrentSession()
	...
	public Contrato findById(com.dromedicas.dto.ContratoId id) {
		log.debug("getting Contrato instance with id: " + id);
		try {
			Contrato instance = (Contrato) sessionFactory.getCurrentSession()
					.get("com.dromedicas.dto.Contrato", id);
			if (instance == null) {
	...
	public List findByExample(Contrato instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.dromedicas.dto.Contrato")
